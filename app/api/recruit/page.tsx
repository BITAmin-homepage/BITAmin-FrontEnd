...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "A. A. 비타민 동아리원들은 공학계열부터 인문계열까지 다양한 학과에 재학 중이기에 학과 제한은 걱정하지 않으셔도 됩니다. <br />데이터 분석에 대한 관심과 열정을 우선으로 생각하고 있습니다.",
  },
  {
    id: 8,
    question: "Q. 지원서 재제출이 가능한가요?",
    answer:
      "A. A. 지원 기간 마감 전까지는 여러 번 제출이 가능합니다. 단, 중복 제출의 경우 가장 마지막에 제출된 지원서로 평가될 예정이니 참고 부탁드립니다.",
  },
  {
    id: 9,
