...
const RECRUITMENT_CONFIG = {
  staffFormUrl: "https://docs.google.com/forms/d/1AUYxegnre9GEscGlzExsGN5jyZwooejQY1CMXrblWYk/edit", // 운영진 지원 폼 URL
  memberFormUrl: "https://docs.google.com/forms/d/1XcGHWv0EGuBTOZNqpzW3BO1dFP28nW8X2CFUXJPaLLw/edit", // 멤버 지원 폼 URL
  cohort: 17,
...
const faqData: FAQItem[] = [
  {
    id: 1,
    question: "Q. <span style='color: #d3431a; font-weight: bold;'>OT 참석</span>이 불가능하면 무조건 불합격인가요?",
    answer: "A. OT는 1년간 비타민 활동 관련 안내 사항과 규칙을 공지하는 중요한 시간이기 때문에 필수참석이 요구되며, <span style='color: #d3431a; font-weight: bold;'>불참 시 불합격 처리</span>됩니다.<br />단, OT 예정일이 정규 세션일과 다르다는 점을 고려하여 불가피한 불참 상황을 참작할 예정입니다.<br />인턴, 계절학기, 입원 등의 상황이 있을 경우 사전에 말씀해주시고, 이후 증빙 자료를 제출해 주시기 바랍니다.",
  },
  {
    id: 2,
    question: "Q. <span style='color: #d3431a; font-weight: bold;'>운영진</span>의 역할은 무엇인가요?",
    answer:
      "A. 운영진은 동아리의 운영을 책임지며 멤버들이 원활한 학습을 할 수 있는 환경을 제공하는 역할을 하며, <br /><span style='color: #d3431a; font-weight: bold;'>교육부/기획홍보부/총무부</span>로 나뉘어 있습니다. 책임감을 가지고 동아리 활동을 하실 수 있는 분들을 환영합니다.",
  },
  {
    id: 3,
    question: "Q. <span style='color: #d3431a; font-weight: bold;'>코딩테스트</span>는 어떻게 진행되나요?",
    answer:
      "A. 코딩테스트는 Python 언어로 진행되며 간단한 반복문&조건문 등 기초문법, 데이터 전처리 및 EDA 등에서 출제됩니다. <br />코딩 테스트는 최대 <span style='color: #d3431a; font-weight: bold;'>25분</span> 동안 진행되며, 이후 면접 약 <span style='color: #d3431a; font-weight: bold;'>25분</span>이 예정되어 있습니다. <br />코딩 테스트를 위해 개인 노트북을 필수로 지참해야한다는 점 참고 부탁드립니다.",
  },
  {
    id: 4,
    question: "Q. <span style='color: #d3431a; font-weight: bold;'>경쟁률</span>은 어느 정도 인가요?",
    answer:
      "A. 경쟁률은 기수마다 상이하기 때문에 확실하게 말씀드리기 어렵습니다. 다만, 면접 대상자는 최종 선발 인원의 <span style='color: #d3431a; font-weight: bold;'>2~2.5배수</span> 정도를 선발합니다.",
  },
  {
    id: 5,
    question: "Q. 동아리 활동 시 <span style='color: #d3431a; font-weight: bold;'>통계나 수학적 지식</span>이 많이 필요한지 궁금합니다.",
    answer:
  ...
  {
    id: 6,
    question: "Q. 코딩테스트 시, 다로 정리해 두었던 <span style='color: #d3431a; font-weight: bold;'>코드 및 강의자료</span>를 보는 것이 가능한가요?",
    answer:
  ...
  {
    id: 7,
    question: "Q. 지원할 때 <span style='color: #d3431a; font-weight: bold;'>학과 제한</span>이 있나요?",
    answer:
      "A. 비타민 동아리원들은 공학계열부터 인문계열까지 다양한 학과에 재학 중이기에 학과 제한은 걱정하지 않으셔도 됩니다. <br />데이터 분석에 대한 <span style='color: #d3431a; font-weight: bold;'>관심과 열정</span>을 우선으로 생각하고 있습니다.",
  },
  {
    id: 8,
    question: "Q. 지원서 <span style='color: #d3431a; font-weight: bold;'>재제출</span>이 가능한가요?",
    answer:
      "A. 지원 기간 마감 전까지는 <span style='color: #d3431a; font-weight: bold;'>여러 번 제출</span>이 가능합니다. 단, 중복 제출의 경우 가장 마지막에 제출된 지원서로 평가될 예정이니 참고 부탁드립니다.",
  },
  {
    id: 9,
    question: "Q. 운영진으로 지원했는데 멤버 <span style='color: #d3431a; font-weight: bold;'>중복 지원</span>도 가능한가요?",
    answer: "A. 네 가능합니다. 다만 동시 지원을 원하실 경우 운영진 모집 구글폼과 멤버 모집 구글폼에 별도의 지원서를 제출해 주셔야 하는 점 참고 부탁드립니다.",
  },
  {
    id: 10,
    question: "Q. <span style='color: #d3431a; font-weight: bold;'>정규 세션</span>은 어디에서 진행되나요?",
    answer: "A. 정규 세션의 경우 <span style='color: #d3431a; font-weight: bold;'>서울 소재 대학교</span>의 강의실을 대관하여 진행하고 있습니다.",
  }
]
...
export default function RecruitPage() {
  ...
  const schedule = {
    ...
    staff: [
      ...
      { title: "운영진 면접", date: "6.26(금) ~ 6.27(토)" },
      { title: "운영진 합격자 발표", date: "6.27(토)" },
    ],
    member: [
      { title: "멤버 서류 결과 발표", date: "6.29(월)" },
      { title: "멤버 면접", date: "7.3(금) ~ 7.4(토)" },
      { title: "멤버 합격자 발표", date: "7.6(월)" },
    ],
    ot: {
      title: "OT",
      date: "7.8(수)",
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-black">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/images/recruiting_bg.png)',
          backgroundSize: '80%',
            ...
            <div className="space-y-4">
              {faqData.map((item) => (
                ...
                >
                  ...
                  >
                    <span 
                      className="text-sm md:text-base font-medium text-gray-300 flex-1"
