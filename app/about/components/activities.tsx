...
export default function ActivitiesSection() {
  ...
  const activities = [
    ...
    },
    {
      ...
      desc: (
        <>
          BITAmin기간 동안 총 5번의 프로젝트를 진행합니다.
          <br /><br />
          학기 시작 전, 관심 있는 분야를 선택해 4~6인이 팀을<br className="md:hidden" /> 구성하고 
          프로젝트를 진행합니다. 방학과 학기 말마다 프로젝트 결과물을 
          공유하는<br className="md:hidden" /> 컨퍼런스를 진행하여, 성과를 발표하는 시간을<br className="md:hidden" /> 갖습니다. 
          <br /><br />
          NLP, CV, 시계열, 추천시스템, 멀티모달 등 본인이 자유롭게 분야를 
          선택할 수 있으며, 정해진 분야 외에도<br className="md:hidden" /> 원하는 주제를 직접 제안해 
          팀을 꾸릴 수 있습니다.
        </>
      ),
    ...
    },
    {
      ...
      desc: (
        <>
          BITAmin에는 관심 분야가 같은 학생들이 모여<br className="md:hidden" /> 
    ...
    },
    {
      ...
      desc: (
        <>
          BITAmin은 데이터·AI 분야 취업이나 대학원 진학을<br className="md:hidden" /> 희망하는 
          동아리원들을 위해 정기적으로<br className="md:hidden" /> 현직자 초청 강연을 개최합니다. 
          특히 BITAmin 출신 선배님들을 모셔 실제 경험담과<br className="md:hidden" /> 진로 준비 
          과정을 직접 들을 수 있습니다. 
          <br /><br />
          강연을 통히 취업 및 대학원 진학에 필요한 실질적인 정보를 얻고 
          선배들과의 네트워킹을 통한<br className="md:hidden" /> 멘토링 기회도 가질 수 있습니다. 
          <br /><br />
          현직자 특강은 단순한 정보 전달을 넘어<br className="md:hidden" /> 
          동아리원들이 앞으로의 진로를 구체적으로 설계하고<br className="md:hidden" /> 
    ...
    },
    {
      ...
      desc: (
        <>
          BITAmin은 동아리 내부에서의 학습과 성장 뿐 아니라<br className="md:hidden" /> 
          외부 커뮤니티 및 기업과의 협업에도 다양한 활동을 이어가고 있습니다. 
          <br /><br />
          타 연합 동아리들과 함께 AI Datathon에 공동<br className="md:hidden" /> 참여하여 
          데이터 분석이나 AI의 이론적 학습을 넘어<br className="md:hidden" /> 실제 데이터를 활용한 
          분석부터 발표까지의<br className="md:hidden" /> 전 과정을 경험합니다. 
          <br /><br />
          이러한 활동을 통해 동아리원들은 단순한 기술 습득을<br className="md:hidden" /> 넘어
    ...
    },
    {
      ...
      desc: (
        <>
          BITAmin은 매년 한 차례 홈커밍데이를 개최하여<br className="md:hidden" /> 선배님들과 
          네트워킹할 수 있는 시간을 마련합니다. 
          <br /><br />
          이 자리에서는 이전 학기의 우수팀 발표와 함께 다양한<br className="md:hidden" /> 
          레크리에이션이 진행되며 선배님들과의 식사 자리를 통해 
          자유롭게 교류할 수 있습니다. 
          <br /><br />
          이를 통해 동아리원들은 선후배 간의 유대감을 다지는<br className="md:hidden" /> 
