        ...
        <div className="max-w-4xl mx-auto mb-20 px-4">
          <div className="text-center space-y-3 leading-relaxed">
            <p className="text-lg md:text-xl text-white/90 font-medium">
              데이터로 세상을 읽고, AI로 내일을 상상합니다.
            </p>
            
            <p className="text-sm md:text-base text-white/70 leading-loose">
              BITAmin은 빅데이터와 인공지능이 만들어낸 변화의 흐름 속에서 미래를 능동적으로 만들어가기 위해 모인 연합 학술동아리입니다.
            </p>
            
            <p className="text-sm md:text-base text-white/70 leading-loose">
              우리는 데이터를 이해하는 능력과 AI를 설계하는 창의성을 확장하여 스스로 문제를 발견하고 답을 만들어가는 여정을 이어갑니다.
            </p>
            
            <p className="text-lg md:text-xl text-white/90 font-medium !mt-12">
              BITAmin은 혼자가 아닌 '함께하는 성장'을 믿습니다.
            </p>
            
            <p className="text-sm md:text-base text-white/70 leading-loose">
              서로 다른 전공과 시각을 가진 학생들이 모여 의견을 나누고 아이디어를 확장하며 작은 배움이 큰 변화로 이어지는 경험을 만들어갑니다.
            </p>
            
            <p className="text-base md:text-lg text-white/70 font-medium mt-8">
              작은 시작이 큰 가능성으로 자라날 그 길 위에 여러분의 흔적이 더해지길 기대합니다.
            </p>
          </div>
        </div>
